    ...
    html: `
      <div class="swal-outline-body">
        <div class="swal-form-group">
          ...
          <input id="swal-item" class="swal2-input swal-input-custom" 
                 value="${element.ASNReqNum || ''}" readonly>
        </div>

        <div class="swal-form-group">
          <label class="swal-label">
            Remarks <span class="swal-required">*</span>
          </label>
          <textarea id="swal-remarks" 
            class="swal2-textarea swal-outline-textarea swal-textarea-custom"
