...
@Component({
  selector: 'app-numberrangesettings',
  standalone: true,
  imports: [CommonModule, MaterialModule, FormsModule, NgApexchartsModule, A11yModule],
  templateUrl: './numberrangesettings.component.html',
  styleUrl: './numberrangesettings.component.scss'
})
export class NumberrangesettingsComponent {
  constructor(
