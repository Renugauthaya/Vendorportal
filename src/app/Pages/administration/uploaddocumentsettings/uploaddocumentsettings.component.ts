...
@Component({
  selector: 'app-uploaddocumentsettings',
  standalone: true,
  imports: [CommonModule, MaterialModule, FormsModule, NgApexchartsModule, A11yModule],
  templateUrl: './uploaddocumentsettings.component.html',
  styleUrl: './uploaddocumentsettings.component.scss'
})
export class UploaddocumentsettingsComponent {
